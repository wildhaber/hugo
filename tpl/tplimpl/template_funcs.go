...
func (t *templateFuncster) initFuncMap() {
	funcMap := template.FuncMap{
		...
		"ipSave":        ipSave,
		"ipCrop":        ipCrop,
		"ipSmartCrop":   ipSmartCrop,
		"ipResize":   	 ipResize,
		"ipThumbnail":   ipThumbnail,
		"ipFlip":   	 ipFlip,
		"ipRotate":   	 ipRotate,
		"ipShear":   	 ipShear,
		"ipTranslate":	 ipTranslate,
		"ipBrightness":  ipBrightness,
		"ipContrast":    ipContrast,
		"ipGamma":   	 ipGamma,
		"ipHue":   	 ipHue,
		"ipSaturation":  ipSaturation,
		"ipBlendMode":   ipBlendMode,
		"ipBlendModeOpacity":   ipBlendModeOpacity,
		"ipBlur":   	 ipBlur,
		"ipExtractChannel":   ipExtractChannel,
		"ipFloodFill":   ipFloodFill,
		"ipDilate":   	 ipDilate,
		"ipEdgeDetection":   ipEdgeDetection,
		"ipEmboss":   	 ipEmboss,
		"ipErode":   	 ipErode,
		"ipGrayscale":   ipGrayscale,
		"ipInvert":   	 ipInvert,
		"ipMedian":   	 ipMedian,
		"ipSepia":   	 ipSepia,
		"ipSharpen":   	 ipSharpen,
		"ipSobel":   	 ipSobel,
		"ipUnsharpMask": ipUnsharpMask,
		"isSet":         isSet,
		"isset":         isSet,
		"jsonify":       jsonify,
		"last":          last,
